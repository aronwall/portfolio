...
| Syfte | Kommando |
| :--- | :--- |
| Processer sorterat på CPU | `Get-Process | Select-Object Name, Id, CPU, StartTime | Sort-Object CPU -Descending` |
...
| Backup av alla GPO:er | `Backup-GPO -All -Path 'C:\GPOBackup'` |
